...
LicenseCompatibility = [
  {
    ...
    value: "notcompatible",
    description: "It is not possible to use together these two licenses."
  },
  {
    label:"Compatible/Relicensing Left",
    value: "left-relicensing",
    description: "Two artifacts can be used and redistributed together under the terms of the more restrictive license."
  },
  {
    label:"Compatible/Relicensing",
    value: "relicensing",
    description: "Two artifacts can be used and redistributed together under the terms of the more restrictive license."
  },
  {
    label:"Compatible/Linking",
    value: "linking",
    description: "Two artifacts can be used together preserving their licenses."
  },
  {
    label: "Compatible/Redistribution",
    value: "redistributed",
    description: "Two artifacts can be used are redistributed together preserving their licenses."
  }
]
